...
class WelcomesControllerTest < ActionController::TestCase
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post :create, welcome: { address: @welcome.address, latitude: @welcome.latitude, longitude: @welcome.longitude }
    end
  ...
  test "should update welcome" do
    patch :update, id: @welcome, welcome: { address: @welcome.address, latitude: @welcome.latitude, longitude: @welcome.longitude }
    assert_redirected_to welcome_path(assigns(:welcome))
  end
