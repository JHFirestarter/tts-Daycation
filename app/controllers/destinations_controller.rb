class DestinationsController < ApplicationController
  ...
  private
    ...
    def destination_params
      params.require(:destination).permit(:name, :dest_type, :description, :characteristics, :travel_cost, :dest_cost, :image, :city, :state, :country, :address, :latitude, :longitude, :dest_url)
    end
end
